...
async function getAll(req, res) {
  ...
  try {
    ...
    await logErrorToDB("ProductController", "getAll", error.message, error.stack);
...
async function create(req, res) {
  try {
    ...
    if (!newProducto) {
      await logErrorToDB("ProductController", "create", newProducto.error||newProducto.Error||"Error al crear el producto", "");
    ...
    await logErrorToDB("ProductController", "create", error.message, error.stack);
  }
}
...
async function update(req, res) {
  try {
    ...
    if (!result) {
      await logErrorToDB("ProductController", "update", result.error||result.Error||"Error al actualizar el producto", "");
    ...
    await logErrorToDB("ProductController", "update", error.message, error.stack);
  }
}
...
async function disable(req, res) {
  try {
    ...
    if (!result){
      await logErrorToDB("ProductController", "disable", result.error||result.Error||"Error al inhabilitar el producto", "");
...
async function enable (req, res) {
  try {
    ...
    if (!result){
      await logErrorToDB("ProductController", "enable", result.error||result.Error||"Error al habilitar el producto", "");
    ...
    await logErrorToDB("ProductController", "enable", error.message, error.stack);
